...
class Registration extends Component{
	...
	handlePatient = (patient) => {
		console.log("patient parent",patient);
        this.setState({patient: patient});
		//navigate('/registration/layanan', { state: patient});
    }

	onSearchResult = (patients) => {
		console.log("onSearchResult parent",patients);
			...
			<div className="container">
			  	...
			  	<div className="row">
			   		<div className="col-12">
						...
						<ListPatients onSelectPatient={this.handlePatient} patients={this.state.patients}/>
						</div>
			    	</div>
			  </div>
			</div>
